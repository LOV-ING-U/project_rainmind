...
- 2026/02/16 추가 : Master 브랜치의 코드들은 구버전 코드이며, 현재 브랜치는 성능 최적화 및 정합성 보강을 위해 생성되었습니다. 현재 브랜치에서는 구버전의 테스트 코드는 동작하지 않을 수 있습니다. 또한, 프로젝트의 기초 설계인 outbox pattern 및 예외 처리 정책에 관한 기술은 구버전 브랜치(https://github.com/LOV-ING-U/project_rainmind)의 Readme에 소개되어 있으며, 현재 브랜치의 Readme는 성능 최적화 및 정합성 보강을 위한 k6, grafana 기반 성능테스트의 결과와 개선 포인트에 관한 내용을 담고 있습니다.  
...
+ 2026.02.08 추가  
별도의 브랜치를 두어, RabbitMQ를 도입하여 Redis 에서 deque 후에 도착을 보장하는 버전을 추가할 예정입니다.  
